...
class HtmlLoadOptions(aspose.pdf.LoadOptions):
    ...
    @property
    def create_logical_structure(self) -> bool:
        '''Gets or sets a value indicating whether to create a logical structure in the resulting PDF document.
        
        When set to Ttrue, the logical structure of the document is created, which can improve accessibility
        and make the document more suitable for screen readers and other assistive technologies.'''
        ...
    
    @create_logical_structure.setter
    def create_logical_structure(self, value: bool):
        ...
...
class Layer:
    ...
    @property
    def default_state(self) -> aspose.pdf.DefaultState:
        '''Gets or sets the default state of the PDF layer.'''
        ...

    @default_state.setter
    def default_state(self, value: aspose.pdf.DefaultState):
        ...
...
class PageExtensions:
    ...
    @staticmethod
    def duplicate_intersecting_graphics(self, page: aspose.pdf.Page, region: aspose.pdf.Rectangle, delta_x: float, delta_y: float) -> None:
        ...
        :param page: The page where graphic elements are searched and copied to.
        :param region: The rectangular region to search for intersecting elements.
        :param delta_x: Offset along the X axis for copied elements.
        :param delta_y: Offset along the Y axis for copied elements.
...
class RtfLoadOptions(aspose.pdf.LoadOptions):
